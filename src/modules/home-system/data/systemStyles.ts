export const homeSystemLayoutStyles = {
  ...
  heroTitle:
    "mt-4 font-title text-[36px] leading-[1.05] text-[#e2e8f8] sm:text-[42px] md:mt-5 md:text-[50px] lg:text-[58px]",
  heroSubtitle:
    "mt-1.5 font-title text-[32px] leading-[1.04] text-[#d6e0f5] sm:text-[36px] md:mt-2 md:text-[44px] lg:text-[52px]",
  heroDescription:
    "mt-4 max-w-[430px] font-mono text-sm leading-7 text-[#8ea2c8] md:mt-6 md:text-[15px] md:leading-8",
  graphColumn:
...
export const moduleCardStyles = {
  ...
  inner:
    "cursor-default rounded-system bg-system-panel px-4 py-3 shadow-panel",
  icon:
  ...
  title: "mt-3 font-title text-sm tracking-[0.12em] text-system-textSoft",
...
export const systemCoreStyles = {
  ...
  panel: "relative rounded-[27px] bg-[#0b1428] p-4 md:p-6",
  pulseOuter:
...
export const sidebarStyles = {
  container:
    "relative z-20 flex h-full w-64 shrink-0 flex-col border-r border-system-borderSoft bg-[#0b1222]/76 px-6 py-8 backdrop-blur-md",
  title: "font-display text-2xl tracking-[0.2em] text-[#d8e5ff]",
  statusDot: "h-2.5 w-2.5 rounded-full bg-system-success shadow-[0_0_10px_rgba(34,197,94,0.7)]",
  terminalIcon:
    "mt-8 flex h-14 w-14 items-center justify-center rounded-xl border border-[#5d7ec133] bg-[#101a31] font-mono text-2xl text-[#9fb7e5]",
  navButton:
    "block w-full rounded-lg px-3 py-2 font-mono text-left text-sm tracking-[0.14em] transition-colors",
  navButtonActive: "bg-[#102142] text-[#9bb8ff]",
  navButtonIdle: "text-[#64769c] hover:bg-[#121e37] hover:text-[#a5b7db]",
} as const;

export const statusBarStyles = {
  container:
    "absolute bottom-0 left-0 right-0 z-20 border-t border-system-borderSoft bg-[#0b1222]/55 px-8 py-4 backdrop-blur-sm",
  content:
    "flex flex-wrap items-center gap-x-7 gap-y-2 text-xs font-mono tracking-[0.08em] text-[#7f93b8] sm:text-sm",
  title: "text-[#9ab2de]",
  online: "text-system-success",
} as const;

export const mobileHomeStyles = {
  sectionLabel: "font-mono text-micro uppercase tracking-wideSystem text-[#5f739d]",
  introCard: "p-4 text-center",
  introCommand: "font-mono text-xs tracking-wideSystem text-left mb-4 text-[#7788ad]",
  introTitle: "mt-2.5 font-title text-[34px] leading-[1.05] text-[#e2e8f8]",
  introSubtitle: "mt-1 font-title text-[28px] leading-[1.05] text-[#d6e0f5]",
  introDescription: "mt-2.5 font-mono text-sm leading-7 text-[#8ea2c8]",
  introCtaWrapper:
  ...
  modulePanel: "rounded-[11px] bg-system-panel px-3 py-2.5 shadow-panel",
  moduleIcon:
    "flex h-7 w-7 items-center justify-center rounded-lg border border-[#5e7ab955] bg-[#0f1a31] font-mono text-xs text-[#8cabff]",
  moduleStatus: "font-mono text-micro tracking-[0.12em] text-system-success",
  moduleTitle:
    "mt-1.5 font-title text-sm tracking-[0.12em] text-system-textSoft",
  moduleRole:
